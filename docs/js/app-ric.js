...
const RIC_ENGINE = {
    ...
    updateQuorumUI: function() {
        ...
        if (type === 'Révocatoire') {
            ...
            scopeLabel = 'des inscrits de la circonscription';
        } else {
            scopeLabel = 'du corps électoral national';
        }
        document.getElementById('quorum-value').innerText = rule.pct + ' %';
        document.getElementById('quorum-desc').innerHTML  =
            scopeLabel + '<br><span style="font-size:0.75rem;">Référence : ' + rule.ref + '</span>';
        document.getElementById('prop-quorum').value = rule.pct;
    },
    login: function() {
...
navigate: function(viewId) {
    ...
    const newRef = {
        ...
        voters: [],
        status: "Attente",
        // Initialisation automatique du fascicule contradictoire avec la description
        fascicule: {
            status: "EN_REDACTION",
            bilan: {
